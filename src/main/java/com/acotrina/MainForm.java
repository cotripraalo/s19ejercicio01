...
public class MainForm extends javax.swing.JFrame {
    ...
    public MainForm() {
        ...
        try {
            Scanner scannerClaro = new Scanner(new FileReader("D:\\jsonClaro.txt"));                        
